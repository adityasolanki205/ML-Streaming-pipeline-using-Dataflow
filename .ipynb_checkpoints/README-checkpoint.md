...
```python
    ...
    def run(argv=None, save_main_session=True):
        ...
        with beam.Pipeline(options=PipelineOptions()) as p:
            ...
            Prediction     = (Converted_data 
                             | 'Predition' >> beam.ParDo(Predict_Data(project=PROJECT_ID, 
                                                         bucket_name='gs://streaming_pipeline_testing', 
                                                         model_path='Selected_Model.pkl',
                                                         destination_name='Selected_model.pkl')))
            output =( Prediction      
...
To test the code we need to do the following:
    ...
    2. Create a Storage Bucket in us-east1 with 2 separate folders temp and stage
    ...
    7. Run the command and see the magic happen:
     ...
     --staging_location gs://streaming_pipeline_testing/stage \
     --region us-east1 \
